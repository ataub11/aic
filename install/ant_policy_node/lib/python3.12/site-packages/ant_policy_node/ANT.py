...
class ANT(Policy):
    ...
    def _localize_connector(
        ...
        the grid scan always yields nothing.  Stage 3's near-port shortcut reliably
        detects the rim signal.
        ...
        fallback (correct for competition T3).  Stage 3 spiral searches ±110 mm.
        ...
        Aggregation (both paths use the SC aggregate block):
          ...
          0 valid estimates → nearest known competition port (Stage 3 spiral covers
          up to ±110 mm offset).
        """
